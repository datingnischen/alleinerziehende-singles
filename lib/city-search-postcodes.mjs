...
/** Individual ICONY search without a preset location, e.g. for cities without their own page. */
/** @param {"de" | "at" | "ch"} market */
export function buildIndividualSearchUrl(market) {
  return `https://alleinerziehende-singles.${market}/suche/?AID=location`;
}
